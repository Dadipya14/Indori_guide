<html>
    ...
    <%
        ...
        PreparedStatement st=con.prepareStatement("select * from tiffinapplicant ");
    ...
    <div style="position: relative">
        ...
        <table align="center" cellspacing="20" class="backtheme">    
            ...
            <tr align="center" bgcolor="white">
                ...
                <td>TIFFIN NAME</td><!-- comment -->
                <td>USERNAME</td><!-- comment -->
                <td>PASSWORD</td><!-- comment -->
                <td>LOCATION</td><!-- comment -->
                <td>TYPE OF CUISINE</td><!-- comment -->
                 <td>CONTACT PERSON NAME</td><!-- comment -->
                <td>CONTACT NUMBER</td><!-- comment -->
                <td>ALTERNATE MOBILE NUMBER</td>
                <td>EMAIL</td><!-- comment -->
                <td>CATEGORY</td>
                <td>YEAR OF STARTING</td><!-- comment -->
                <td>MONTHLY RENT</td><!-- comment -->
                <td>SINGLE TIFFIN RATE</td>
                <td>TIMING</td>
                <td>DESCRIPTION ABOUT TIFFIN</td><!-- comment -->
                <td>MEALS FOR PATIENTS</td><!-- comment -->
                <td>MODES OF PAYMENT</td>
                <td>TIFFIN ID</td><!-- comment -->
